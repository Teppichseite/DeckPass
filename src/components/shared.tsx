...
export const ModalContent = (props: ModalContentProps) => {
    ...
    return <>
        ...
        <Button
            ...
            >Confirm</ButtonItemIconContent></Button >
        <Button
            disabled={isLoading}
            className="DialogButton Secondary"
            onClick={() => props.closeModal?.()}><ButtonItemIconContent justifyContent="center" icon={<FaBan />}
            >Cancel</ButtonItemIconContent></Button>
    </>
}
